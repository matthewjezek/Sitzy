...
sequenceDiagram
    ...
    Alice->>Frontend: Pošle pozvánku Bobovi
    Frontend->>Backend: POST /rides/42/invite<br/>{invited_email: "bob@ex.com"}
    ...
    Note over Alice,Database: Flow v praxi:<br/>1. Alice vytvoří auto<br/>2. Vytvoří jízdu (stává se řidičem)<br/>3. Pozve Boba<br/>4. Bob přijme → stane se pasažérem<br/>5. Alice převede řízení na Boba<br/>(Bob musí být pasažér)
```
...
3. **Alice** pošle pozvánku **Bobovi** na konkrétní jízdu
