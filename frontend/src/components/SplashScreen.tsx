...
export default function SplashScreen({ onComplete }: SplashScreenProps) {
  ...
  useEffect(() => {
    ...
    // Dot animation
    tl.to('#dot', { x: 152.5, fill: '#6345d6', duration: 1.2, ease: 'power1.inOut'}, 'morph')
      .to('#dot', { y: -40, duration: 0.6, ease: 'sine.out'}, 'morph')
      .to('#dot', { y: 23, duration: 0.6, ease: 'sine.in'}, 'morph+=0.6')

    // Fade out letters
    tl.to('#letters-sit', { x: -50, opacity: 0, duration: 0.8, ease: 'power2.inOut' }, 'morph+=0.4')
      .to('#letter-y', { x: 50, opacity: 0, duration: 0.8, ease: 'power2.inOut' }, 'morph+=0.4')
  ...
  return (
    <div className="relative w-full flex items-center justify-center">
      <svg viewBox="0 0 325 122" id="main-svg" overflow="visible" className="w-full max-w-md px-8">
