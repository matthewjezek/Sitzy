          ...
          <div className="radio-inputs">
            <label>
              <input
                ...
                name="layout"
                value="sedaq"
                checked={layout === 'sedaq'}
                onChange={() => setLayout('sedaq')}
              />
              <span className="radio-tile">
                <span className="radio-icon">
                  {/* Sedan SVG (reuse motorbike for demo) */}
                  <svg stroke="currentColor" viewBox="0 0 467.168 467.168" fill="none" width="32" height="32">
                    <g>
                      <g>
                ...
                <span className="radio-label">Sedan (4 místa)</span>
              </span>
            </label>
            <label>
              <input
                ...
                name="layout"
                value="trapaq"
                checked={layout === 'trapaq'}
                onChange={() => setLayout('trapaq')}
              />
              <span className="radio-tile">
                <span className="radio-icon">
                  {/* Kupé SVG */}
                ...
                <span className="radio-label">Kupé (2 místa)</span>
              </span>
            </label>
            <label>
              <input
                ...
                value="praq"
                checked={layout === 'praq'}
                onChange={() => setLayout('praq')}
              />
              <span className="radio-tile">
                <span className="radio-icon">
                  {/* Minivan SVG (reuse bicycle for demo) */}
                  <svg stroke="currentColor" viewBox="0 0 493.407 493.407" fill="none" width="32" height="32">
                    <g>
                ...
                <span className="radio-label">Minivan (7 míst)</span>
              </span>
            </label>
          </div>
        </div>
